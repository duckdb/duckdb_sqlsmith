...
unordered_map<string, RandomPercentagesEnum> StringToRandomPercentagesEnum = {
    ...
    { "window_function_expression", RandomPercentagesEnum::WINDOW_FUNCTION_EXPRESSION },
    { "window_function_random_expression", RandomPercentagesEnum::WINDOW_FUNCTION_RANDOM_EXPRESSION },
    ...
    { "star_column_name_with_expression", RandomPercentagesEnum::STAR_COLUMN_NAME_WITH_EXPRESSION },
    ...
    { "position_reference", RandomPercentagesEnum::POSITION_REFERENCE },
